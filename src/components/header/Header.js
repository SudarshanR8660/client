      ...
      <div className="flex items-center space-x-4">
        ...
        <ShowOnLogin>
          <a href="/" className="flex items-center text-blue-500">
            ...
            <span className="ml-2">Hi, {displayName}</span>
          </a>
        </ShowOnLogin>

        <ShowOnLogin>
          <NavLink to="/wishlist" className="hover:text-blue-500">Wishlist</NavLink>
        </ShowOnLogin>

        <ShowOnLogin>
          <NavLink to="/OrderHistory/users/:userId/orders" className="hover:text-blue-500">My Orders</NavLink>
        </ShowOnLogin>
