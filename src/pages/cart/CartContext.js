...
//     try {
//       const response = await fetch(`https://server-1-27iv.onrender.com/api/cart/${userId}`);
//       if (response.ok) {
...
//   const addToCart = async (userId, productId, name, brand, desc, price, imageURL) => {
//     try {
//       const response = await fetch('https://server-1-27iv.onrender.com/api/cart', {
//         method: 'POST',
...
//   const removeFromCart = async (userId, productId) => {
//     try {
//       const response = await fetch(`https://server-1-27iv.onrender.com/api/cart/${userId}/${productId}`, { method: 'DELETE' });
//       if (response.ok) {
//         toast.success('Product removed from cart successfully');
//         fetchCart(userId); // Fetch the cart again to update the state
//       } else {
...
//   const fetchCart =async (userId) => {
//     // Make a request to fetch cart data from the server using the userId
//     fetch(`https://server-1-27iv.onrender.com/api/cart/${userId}`)
//       .then((response) => {
//         // Check if the response is successful
//         if (!response.ok) {
//           throw new Error('Failed to fetch cart data');
...
//   const fetchCart = async (userId) => {
//     try {
//       const response = await fetch(`https://server-1-27iv.onrender.com/api/cart?userId=${userId}`);
//       const data = await response.json();
//       setCart(data);
//     } catch (error) {
//       console.error('Fetch cart error:', error);
